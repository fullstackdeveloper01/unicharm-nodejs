...
exports.createDesignation = async (req, res) => {
  try {
    ...
    if (DepartmentId) {
      const departmentService = require('../../services/superAdmin/department.service.js');
    ...
    const designation = await createDesignation({ DesignationName, DepartmentId, Category });
    res.status(201);
 ...
 */
const updateDesignation = async (designation, data) => {
 ...
 * @returns {Promise<Array>} Dropdown items
 */
const selectExpenseDesignations = async () => {
...
// -----------------------------
    ...
    const updatedDesignation = await updateDesignation(designation, { DesignationName, DepartmentId, Category });
...
exports.deleteDesignation = async (req, res) => {
  try {
    ...
    await deleteDesignation(designation);
...
exports.selectExpenseDesignations = async (req, res) => {
  try {
    const dropdown = await selectExpenseDesignations();
