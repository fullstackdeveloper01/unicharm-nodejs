...
const { CorporatePricePolicy } = require('../../models/superAdmin');
 ...
 */
const getAllCorporatePricePolicies = async (page = 1, limit = null, search = '') => {
 ...
 */
const getCorporatePricePolicyById = async (id) => {
 ...
 */
const createCorporatePricePolicy = async (data) => {
 ...
 */
const updateCorporatePricePolicy = async (id, data) => {
 ...
 */
const deleteCorporatePricePolicy = async (id) => {
...
exports.getAllCorporatePricePolicies = async (req, res) => {
    try {
        ...
        const result = await getAllCorporatePricePolicies(page, limit, search);
...
exports.getCorporatePricePolicyById = async (req, res) => {
    try {
        ...
        const policy = await getCorporatePricePolicyById(id);
...
exports.createCorporatePricePolicy = async (req, res) => {
    ...
    uploadMiddleware(req, res, async (err) => {
        ...
        try {
            ...
            const policy = await createCorporatePricePolicy(policyData);
...
exports.updateCorporatePricePolicy = async (req, res) => {
    ...
    uploadMiddleware(req, res, async (err) => {
        ...
        try {
            ...
            const updatedPolicy = await updateCorporatePricePolicy(id, updateData);
...
exports.deleteCorporatePricePolicy = async (req, res) => {
    try {
        ...
        await deleteCorporatePricePolicy(id);
