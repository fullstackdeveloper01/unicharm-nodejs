...
const getTicketSummary = async (employeeId) => {
...
const getTicketList = async (employeeId, query) => {
...
const getDropdowns = async (type, query) => {
    if (type === 'Region') {
...
const createTicket = async (data, employeeId, file) => {
...
const getTicketStatusSummary = async () => {
...
const getTicketStatusList = async (query) => {
 ...
 */
const sendTicketReply = async (ticketId, employeeId, message, file, status) => {
    const ticket = await Ticket.findByPk(ticketId);
    if (!ticket) throw new Error('Ticket not found');
 ...
 */
const transferTicket = async (ticketId, assigneeId, employeeId) => {
    const ticket = await Ticket.findByPk(ticketId);
    if (!ticket) throw new Error('Ticket not found');
 ...
 */
const submitFeedback = async (ticketId, employeeId, feedbackData) => {
    const ticket = await Ticket.findByPk(ticketId);
    if (!ticket) throw new Error('Ticket not found');
...
const getTicketReportSummary = async () => {
    return await exports.getTicketStatusSummary();
};

const getTicketReportGraph = async () => {
...
const getTicketSummaryList = async (query) => {
...
exports.getMyTicketSummary = async (req, res) => {
    try {
        const data = await getTicketSummary(req.user.id);
...
exports.getMyTicketList = async (req, res) => {
    try {
        const data = await getTicketList(req.user.id, req.query);
...
exports.getTicketDetails = async (req, res) => {
    try {
        const data = await getTicketDetails(req.params.id);
...
exports.getDropdowns = async (req, res) => {
    try {
        ...
        const data = await getDropdowns(type, req.query);
...
exports.createTicket = async (req, res) => {
    try {
        ...
        const file = req.file;
        const data = await createTicket(ticketData, req.user.id, file);
...
exports.getOrganizationTicketSummary = async (req, res) => {
    try {
        const data = await getTicketStatusSummary();
...
exports.getOrganizationTicketList = async (req, res) => {
    try {
        const data = await getTicketStatusList(req.query);
...
exports.getTicketReportSummary = async (req, res) => {
    try {
        const data = await getTicketReportSummary();
...
exports.getTicketReportGraph = async (req, res) => {
    try {
        const data = await getTicketReportGraph();
...
exports.getReplies = async (req, res) => {
    try {
        ...
        const data = await getTicketReplies(ticketId, req.user.id);
...
exports.sendReply = async (req, res) => {
    try {
        ...
        const data = await sendTicketReply(ticketId, req.user.id, message, file, status);
...
exports.transferTicket = async (req, res) => {
    try {
        ...
        const data = await transferTicket(TicketId, AssigneeId, req.user.id);
...
exports.submitFeedback = async (req, res) => {
    try {
        ...
        const data = await submitFeedback(ticketId, req.user.id, feedbackData);
...
exports.downloadReport = async (req, res) => {
    try {
        ...
        const listData = await getTicketSummaryList(req.query);
