const photoGalleryService = require('../../services/superadmin/photoGalleryService');
...
exports.getAllPhotoGalleries = async (req, res) => {
    try {
        ...
        const result = await photoGalleryService.getAllPhotoGalleries(page, limit, search);
